    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/response/student/:exam/:student" element={<ResultDetail />} />
          <Route path="/response/faculty/:exam" element={<ResponseDetail />} />
